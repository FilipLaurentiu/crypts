...
from contracts.modules.IConfigurationModule import IConfigurationModule
from contracts.IVault import IVault
...
@external
func initializeConfigModule{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(vault : felt):
